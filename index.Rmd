---
title: "NCAA Womens Volleyball Statistics"
description: |
  Below are the statistics across the entire NCAA Womens Volleyball Seasons from 2012-2019!
site: distill::distill_website
---
## Introduction
NCAA Women's Volleyball statistics vary greatly by team and the amount of wins that a team will achieve based on their statistics throughout the season. The data was from the ncaa_2012-2019 excel spreadsheet which contained data for all of the teams in NCAA Women's Volleyball. Then the data was filtered to take specific information about hitting, attacking and defending. It takes a large number of attack attempts for teams to secure a kill.
